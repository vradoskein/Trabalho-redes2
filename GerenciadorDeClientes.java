...
//gerenciador de clientes comunica ncom o servidor e entre clientes
public class GerenciadorDeClientes extends Thread {
	...
	//lista de clients do servidor, Map
	...
	/**
	 * Metodo q faz a cv entre os clients
	 */
	@Override
	public void run() {
		try {
			...
			efetuarLogin();//logica login
			
			String msg;
			//loop p diversas msgs
			while(true){
				msg = leitor.readLine();
